...
export const REPORT_SCHEMAS = {
  ...
  doi_chieu: {
    ...
    measures: [
      ...
      { key: "soChiTiet", header: "Số CT", format: "int" },
    ],
    defaultGroupBy: ["ncc", "hangHoa"],
    defaultSort: "thucNhan",
  },
  ...
  vong_doi: {
    dimensions: [
      { key: "maDon", header: "Mã đơn" },
      { key: "ncc", header: "Nhà cung cấp" },
      { key: "trangThaiDon", header: "Trạng thái đơn" },
      { key: "ngayDat", header: "Ngày đặt" },
      { key: "user", header: "Người tạo" },
    ],
    measures: [
      { key: "soChiTiet", header: "Số chi tiết", format: "int" },
      { key: "soLuongDat", header: "SL đặt (tấn)", format: "num" },
      { key: "thucNhan", header: "Thực nhận (tấn)", format: "num" },
      { key: "thucGiao", header: "Thực giao (tấn)", format: "num" },
      { key: "soChuyenGiao", header: "Số chuyến giao", format: "int" },
      { key: "tyLeNhan", header: "% Nhận", format: "num" },
      { key: "tyLeGiao", header: "% Giao/Nhận", format: "num" },
    ],
    defaultGroupBy: ["maDon", "ncc", "trangThaiDon"],
    defaultSort: "ngayDat",
  },
} as const;
